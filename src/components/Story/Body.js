  ...
  // console.log(para)
    return (
        ...
        <div className='w-full flex flex-col items-center mt-5'>
            ...
            para.length > 0?
            para.map((item)=>{
               return   item.content.map((one)=>{
                       return <p className='text-sm text-left capitalize font-medium mt-2'>{one.value}</p> 
                  }) 
            })
            
            :[]
          }
            {/* <p className='text-sm text-left capitalize font-medium'>
            ...
            {/* <p className='text-sm text-left capitalize font-medium mt-6'>
            ...
            Engraved attention to detail elegant with neutral colours cheme 
              ...
              {/* <span className='flex flex-row items-center mt-10'>
                <a className='text-2xl font-extrabold w-14 '>,,</a>

                <a className='w-2/3 text-lg text-left capitalize font-bold'>
                KINCKER LINING CONCEALED BACK ZIP FASTEN SWING STYLE HIGH WAITSTED DOUBLE LAYER FULL PATTERN FLORAL
                </a>
              </span> */}

              {/* <p className='text-sm text-left capitalize font-medium mt-3'>
              ...
              <p className='text-sm text-left capitalize font-medium mt-4'>
