...
import pink from '../../images/pink bg.png'
export default function Subscribe() {
    return (
        <div className=' lw-full flex flex-row items-center justify-center mt-5'>
                <section className='hidden sm:hidden md:hidden lg:w-10/12 lg:relative lg:flex lg:items-center lg:justify-center'>
                        <img src={pink} className='w-full h-full' />




        <div className='w-3/4 absolute flex flex-col items-center m-auto bg-black mt-5 py-5'>

<section className='w-full flex flex-col items-center justify-center mt-4'>
   <h2 className='text-5xl capitalize font-bold text-white'>Sign up for our newsletters</h2>
    <p className='text-base capitalize font-bold text-white mt-3'>get notified of the best newletter</p>
</section>
...
{/* small screen */}
                <div className='w-11/12 sm:w-11/12 md:w-11/12 lg:hidden flex flex-col items-center m-auto bg-black mt-5 py-5'>
